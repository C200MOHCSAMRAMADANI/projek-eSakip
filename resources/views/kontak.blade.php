<div class="container mt-4 mb-5">
    <div class="page-header-bar mb-4 shadow-sm">
        <i class="fas fa-address-book fa-lg me-2"></i> 
        <span class="text-uppercase">Kontak</span>
    </div>
    <div class="bg-white p-5 rounded shadow-sm">
        <div class="row">
            <div class="col-md-6 mb-4 mb-md-0">
                ...
                <p><i class="fas fa-map-marker-alt text-primary fa-lg me-2"></i> Alamat : <a href="https://maps.app.goo.gl/Gh5AQLZYE3h4ZhhU9" target="_blank" class="text-decoration-none text-primary">Jl. Brigjen Katamso, Purbosari, Wonosari, Kec. Wonosari, Kabupaten Gunungkidul, Daerah Istimewa Yogyakarta 55851</a></p>
            ...
            <div class="col-md-6">
                ...
                <div class="d-grid">
                    <a href="https://maps.app.goo.gl/mpyJTXh1xoBvdBns9" target="_blank" class="btn btn-primary shadow-sm py-2"><i class="fas fa-map-marked-alt me-2"></i> Buka di Google Maps</a>
                </div>
            </div>
        </div>
    </div>
